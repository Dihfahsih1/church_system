...
urlpatterns = [
    ...
    url(r'^receptionist_view_driver_payments$', receptionist_view_driver_payments, name="receptionist_view_driver_payments"),
    ...
    url(r'^accountant_print_driverfinancial_report/(?P<driver_name>.+?)/$', accountant_generate_driver_financial_report.as_view(), name="accountant_print_driverfinancial_report"),
    ...
    url(r'^generate_operations_driver_financial_statement/(?P<driver_name>.+?)/$', generate_operations_driver_financial_statement.as_view(), name="generate_operations_driver_financial_statement"),
    ...
    url(r'^accountant_display_driver_financial_statement/(?P<driver_name>.+?)/$', accountant_display_driver_financial_statement, name="accountant_display_driver_financial_statement"),
    url(r'^operations_display_driver_financial_statement/(?P<driver_name>.+?)/$', operations_display_driver_financial_statement, name="operations_display_driver_financial_statement"),
    url(r'^receptionist_display_driver_financial_statement/(?P<driver_name>.+?)/$', receptionist_display_driver_financial_statement, name="receptionist_display_driver_financial_statement"),
    ...
    url(r'^accountant_driver_payment_archive_print/(?P<report_month>.+?)/(?P<report_year>.+?)/$', accountant_driver_payment_archive_print.as_view(), name="accountant_driver_payment_archive_print"),
    ...
    url(r'^accountant_delete_driver_payment/(?P<pk>\d+)$',accountant_delete_driver_payment,name="accountant_delete_driver_payment"),
    ...
    #EDITING FIELDS AND DELETING RECORDS
    ...
    url(r'^delete_salary/(?P<pk>\d+)', delete_salary ,name='delete_salary'),
    url(r'^delete_sundry/(?P<pk>\d+)', delete_sundry ,name='delete_sundry'),

    #DISPLAYING CURRENT MONTHLY REPORT
    ...
    url(r'^accountant_print_staff/',accountant_print_staff.as_view(), name='accountant_print_staff'),
